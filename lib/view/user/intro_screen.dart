    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Row(
          ...
          children: [
            Text("Skip now",style: TextStyle(color: Colors.black),),
            SizedBox(width: 15,),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFDC1A47),width: 2,)
                ),
                child: const Center(child: Text("Login",style: TextStyle(color: Colors.pinkAccent),)),
              ),
            ),
            const SizedBox(height: 20,),
            Container(
